/**
 * Created by sand_yu on 14-9-1.
 */
/**
 * Created by sand_yu on 14-6-20.
 */

!function(){
    var bP={};
    var b=30, bb=150, height=600, buffMargin=1, minHeight=14;
    var c1=[-150, 40], c2=[-50, 150], c3=[-10, 190]; //Column positions of labels.
    var colors =["#00a0b0", "#ffd600", "#D4020F","#23b7b7", "#f5a80e", "#D4020F"];
